...
public class Produto {
	...
	@NotBlank(message = "O atributo de data de validade é Obrigatório!")
	@Size(min = 3, max = 50, message = "O atributo de data de validade deve conter no minimo 3 e no máximo 50 caracteres")
